...
module PageCanvas =
    ...
    let version = 0.1
    let mutable FirstClick = DateTime.Now.ToLongTimeString()
    ...
    let update (msg: Msg) (state: State): State * Cmd<_> =
        ...
        | BoxClicked id ->
            ...
            let (clicked, currentName) = 
                ...
                | Some bx when bx.Id = id -> (Some bx, bx.Name) 
                | _ -> 
        ...
        | CurrentNameChanged text ->
            ...
            | Some bx ->
                ...
                { state with CurrentBox = Some updated; BoxList = boxes; CurrentName = text }, Cmd.none
            | None ->
                state, Cmd.none
